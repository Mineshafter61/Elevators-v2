...
public class ChuList<E> extends ArrayList<E> 
{
    ...
    @SafeVarargs public ChuList(E... elements) 
    {
        super();
    ...
    @Override public ChuList<E> subList(int fromIndex, int toIndex) 
    {
        if(fromIndex < 0) 
        {
            fromIndex = 0;
        ...
        {
            list = super.subList(toIndex, fromIndex); 
        }
        else
        {
...
class ChuIterator<E> implements Iterator<E> 
{
    ...
    public ChuIterator(ChuList<E> l) 
    { 
        list = l; 
    }
